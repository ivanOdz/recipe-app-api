...
class PrivateRecipeApiTests(TestCase):
    ...
    def test_create_recipe_with_new_ingredients(self):
        ...
        payload = {
            ...
            'time_minutes': 30,
            'price': Decimal('2.5'),
            'ingredients': [{'name': 'Lettuce'}, {'name': 'Dinner'}]
        }
    ...
    def test_create_ingredient_on_upate(self):
    ...
    def test_filter_by_tags(self):
        ...
        tag2 = Tag.objects.create(user=self.user, name='Vegatarian')
        r1.tags.add(tag1)
        r2.tags.add(tag2)
    ...
    def test_filter_by_ingredients(self):
        ...
        r1 = create_recipe(user=self.user, title='Pancho con papas fritas')
        r2 = create_recipe(user=self.user, title='Milanesa de carne')
        in1 = Ingredient.objects.create(user=self.user, name='Salchicha')
        in2 = Ingredient.objects.create(user=self.user, name='Lomo')
        r1.ingredients.add(in1)
        r2.ingredients.add(in2)
        r3 = create_recipe(user=self.user, title='Empanadas tucumanas')
